    ...
    <div class="h-full py-4 px-5 flex">
        <div class="w-8/12 h-full block mr-5">
            ...
            <div class=" mt-5 w-full bg-white rounded px-7 py-6">   
                ...
                <a href="{{ route('perfil', ['email' => $anuncio->email]) }}">
                ...
                <div class="block text-lg">
                    <span class="capitalize">{{ $anuncio->nomeanunc }}</span> <br>
                <div class="text-xs text-gray-500">
                    No OLX desde <span class="font-bold">{{ $user->created_at->format('Y-d-m') }}</span>
                </div>
                </div>
            </div>
            </div>
...
<div class=" lg:hidden mb-20">
    <div class="h-2/5 bg-black flex items-center justify-center">
        <img src="{{ url('/storage/'.$anuncio->foto) }}" class="object-cover w-full h-full" alt="">
    </div>
    <div class=" w-full bg-white rounded px-3 py-6 border-xl">
        <div class="text-xs text-gray-500">
            Publicado em {{ $anuncio->data_criacao }}
        </div>
