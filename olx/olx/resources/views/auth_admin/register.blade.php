                ...
                <div class="flex-auto">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="">
                            ...
                            <div class="flex flex-wrap mb-3">    
                                <label for="password-confirm" class="md:pr-4 pl-4 pt-2 pb-2 mb-0 leading-normal text-md-end name-label">Escolher tipo de conta</label>
                                <div class="w-11/12 mx-auto">
                                <select id="type" class="block w-full py-1 px-2 mb-1 border-b-2 focus:outline-none focus:border-b-4 text-base bg-gray-100 text-gray-800 border border-gray-200 name-input @error('name') bg-red-700 @enderror" name="type">
